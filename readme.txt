=== Safe2Pay para WooCommerce ===
Contributors: Safe2Pay
Donate link: https://safe2pay.com.br/
Tags: woocommerce, pagamento, boleto, cartão de crédito, bitcoin
...
Plugin para WooCommerce que permite aceitar pagamentos via boleto bancário, cartão de crédito e bitcoin com checkout 100% transparente e fácil de usar.

== Descrição ==

O plugin do Safe2Pay para WooCommerce permite você aceitar pagamentos via boleto bancário, cartão de crédito e bitcoin diretamente na sua loja online, com rapidez, facilidade e com checkout 100% transparente.
...
- Plugin [Brazilian Market on WooCommerce](https://br.wordpress.org/plugins/woocommerce-extra-checkout-fields-for-brazil/).
- O split utilizará os números de documento informados para os vendedores na
